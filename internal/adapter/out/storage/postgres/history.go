...
func (s *Store) RecordObserverRun(ctx context.Context, sessionID live.SessionID, revision uint64, messages []string, observation observer.Observation, errorMessage string) error {
